...
public class Sprite {
    ...
    public static final int SCALED_SIZE = DEFAULT_SIZE * Game.SCALE;
    ...
    |--------------------------------------------------------------------------
     */
    public static Sprite player_up = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.tiles, 14, 16);
